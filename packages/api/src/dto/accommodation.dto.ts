...
import { IsBoolean, IsDateString, IsEmail, IsIn, IsInt, IsMongoId, IsNotEmpty, IsOptional, IsString, Max, MaxLength, Min } from 'class-validator';
...
export class SignExternalTenancyAgreementDto {
    ...
    @IsIn(['father', 'mother', 'uncle', 'aunt', 'brother', 'sister', 'grandfather', 'grandmother', 'other_blood_relative']) guarantorRelationship: string;
